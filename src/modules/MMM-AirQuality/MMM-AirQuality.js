...
Module.register("MMM-AirQuality", {
	...
	getScripts: function () {
		return ["aqiFeed.js", "//cdnjs.cloudflare.com/ajax/libs/jquery/2.2.2/jquery.js", "String.format.js"];
	},
	getStyles: function () {
	...
	getDom: function () {
		...
		wrapper.innerHTML = this.html.quality.format(this.html.icon, this.data.impact, this.config.showIndex ? " (" + this.data.value + ")" : "") + (this.config.showLocation ? this.html.city.format(this.data.city) : "");
		return wrapper;
	}
});
